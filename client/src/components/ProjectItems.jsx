...
const {projectName, mobileImage, github, deployed, youtube}= data

  if (loading) return <p>add spinner here</p>;

  return (
    <Fragment>
      <section className=' w-screen my-4 flex justify-center items-center text-neutral-content gap-x-16 '>
