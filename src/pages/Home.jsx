  ...
  return (
    <section>
      <div className='flex flex-row justify-center w-full my-10'>
        <a href='https://fashionshopservice.onrender.com/' alt=' link to deployed ecommerce app'>
          <div className='card w-96 bg-base-100 shadow-xl image-full mx-10'>
            ...
            <div className='card-body'>
              ...
              <p className='text-primary text-xs sm:text-base'>
                E-commerce Fashion shop Created with React, Redux Toolkit, Bootstrap,
                React-Bootstrap CSS, Express, Node.js, Mongodb, and Mongoose.
              </p>
