...
const Meta = ({ title, description, keywords }) => {
  return (
    <Helmet>
      ...
      <meta name='title' key='title' content={title ? title : 'Welcome Greg Petropoulos Frontend Portfolio'}/>
      <meta name='Greg Petropoulos portfolio as a full stack React and React Native MERN developer'
      ...
      <link rel='canonical' href={window.location.href} />
       ...
       {/* FB */}
       <meta property='og:title' key='og:title'content={title ? title : 'Welcome Greg Petropoulos Frontend Portfolio'}/>
      ...
      />
       <meta property='og:image' key='og:image' content='../src/assets/images/desktop/desktop-profile.jpg'/>
      {/* // content={`${process.env.BASE_URL}/images/frontend.jpeg`} */}

      <meta property='og:url' content='https://gregpetropoulos.dev/' />
       
       {/* TWITTER */}
       <meta property='twitter:title' content={title ? title : 'Welcome Greg Petropoulos Frontend Portfolio'}/>
