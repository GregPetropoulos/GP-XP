import supportDeskImageUrl from '../images/mobile/support-desk.png';
import iTLoggerImageUrl from '../images/mobile/it-logger.png';
import devSquadImageUrl from '../images/mobile/dev-squad.png';
import ecommerceFashionImageUrl from '../images/mobile/ecommerce.png';
...
import saCornerstoneLogo from '../images/mobile/saCornerstoneLogo.png';
...
const projectData = [
  {
    ...
    description:
      ' A Support Desk Services application is a customer facing product support system to engage with technicians and solve reported issues',
    year: '2022',
    type: 'website',
  },
  {
...

  {
    id: 7,
    workType: 'work',
    projectName: 'SA Cornerstone App',
    mobileImage: saCornerstoneLogo,
    tech: ['React Native', 'Android', 'iOS'],
    youtube: '',
    deployed: 'https://apps.apple.com/us/app/sa-cornerstone/id1664265654',
    github: '',
    description: ` A mobile app on the App store and Google Play that supports the saCornerstone ministries, a sister application to the Cornerstone Website running on the same React Native Code Base.`,
    year: '2023',
    type: 'mobileApp',
  },
];
